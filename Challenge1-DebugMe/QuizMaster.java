...
public class QuizMaster {
       ...
       public static void main(String[] args) {
               ...
               if(zip/1000 == 48 && score != 40){ //Michigan students who didn't score 40
                       score = 0;
               ...
               if (zip/1000 == 61 && score != 40){//Illinois students who didn't get score 40
       		   	   System.out.println("You scored:" + score);
               }
               if (zip/1000 == 61 && score == 40){ //Illinois students who got 40
            	   	   System.out.println("You scored:" + score);
               		   System.out.println("Congratulations!");
               		   
               }
           	   
               if (zip/1000 != 61 && zip/1000 != 48 && score != 40 && score != 0){ //Wisconsin students who didn't get 40 points
                	   score = 20;
                	   System.out.println("You scored:" + score);
               }
               if (zip/1000 != 61 && zip/1000 != 48 && score == 40){
                	   System.out.println("You scored:" + score);
               }
